...
console.log(`Tyrannosaurus weights ${tyrannosaurus.weight}.`);

// What was the diet of a velociraptor?
console.log(`Velociraptors is ${velociraptor.diet}.`);
...
zooAnimals.reduce((total, animal) => (populationTotal += animal.population), 0);
